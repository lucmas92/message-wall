...
const PROFANITY_LIST: string[] = [
  ...
  'diobo', 'dioca', 'diopor', 'diomer', 'diocan', 'diamma', 'diofa', 'diogu',
  'porcod', 'gesucr', 'madonnac',

  // 2. INSULTI SESSUALI E VOLGARI (Radici aggressive)
  'cazz', 'fott', 'culatt', 'puttan', 'troi', 'bordel', 'succhia',
  'fellat', 'segh', 'coion', 'cogl', 'pomp',
  ...
  'bastard', 'idiot', 'vaffanc', 'rompic', 'testadic', 'defic', 'negro',
  'froc', 'zingar', 'terron', 'ebreo', 'razzis', 'omofob', 'nazis', 'fascist',
];
...
export class ProfanityService {
    ...
    public check(text: string): boolean {
        ...
        let normalized = leetNormalize(text.toLowerCase());
        ...
        const searchString = punctuationFree
            .replace(/\s+/g, '#')
            .replace(/[^a-z0-9#]/g, '');
